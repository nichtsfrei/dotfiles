...
hi Folded           ctermfg=242     ctermbg=0     cterm=NONE      guifg=#666666       guibg=#1C1C1C   gui=NONE
hi IncSearch        ctermfg=234     ctermbg=75      cterm=NONE      guifg=#1C1C1C       guibg=#5FAFFF   gui=NONE
hi LineNr           ctermfg=59      ctermbg=0     cterm=NONE      guifg=#5F5F5F       guibg=#1C1C1C   gui=NONE
...
hi NonText          ctermfg=234     ctermbg=0     cterm=NONE      guifg=#1C1C1C       guibg=#1C1C1C   gui=NONE
hi Normal           ctermfg=255     ctermbg=0       cterm=NONE      guifg=#EEEEEE       guibg=#1C1C1C   gui=NONE
...
hi Comment          ctermfg=253     ctermbg=NONE    cterm=NONE      guifg=#585858       guibg=NONE      gui=NONE
